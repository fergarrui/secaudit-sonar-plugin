...
@Rule(key = "HttpServletRequestCheck")
public class HttpServletRequestCheck extends IssuableSubscriptionVisitor {

  private static final String HTTP_SERVLET_CLASS_NAME = "javax.servlet.http.HttpServlet";
