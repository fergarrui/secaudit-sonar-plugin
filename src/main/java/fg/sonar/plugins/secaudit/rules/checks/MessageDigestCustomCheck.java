...
@Rule(key = "MessageDigestCustomCheck")
public class MessageDigestCustomCheck extends IssuableSubscriptionVisitor {

  private static final String MESSAGE_DIGEST_FULLY_NAME = "java.security.MessageDigest";
