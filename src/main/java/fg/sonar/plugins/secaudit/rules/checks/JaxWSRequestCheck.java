...
@Rule(key = "JaxWSRequestCheck")
public class JaxWSRequestCheck extends IssuableSubscriptionVisitor {

  private static final String JAX_WS_WEBMETHOD_NAME = "javax.jws.WebMethod";
