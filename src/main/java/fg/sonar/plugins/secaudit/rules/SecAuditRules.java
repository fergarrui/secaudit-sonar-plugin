...
import fg.sonar.plugins.secaudit.rules.checks.DeserializationCheck;
import fg.sonar.plugins.secaudit.rules.checks.FilePathTraversalCheck;
import fg.sonar.plugins.secaudit.rules.checks.FileUploadCheck;
...
import fg.sonar.plugins.secaudit.rules.checks.InsufficientSessionExpirationCheck;
...
import fg.sonar.plugins.secaudit.rules.checks.xpath.XPathInjectionCheck;
...
public class SecAuditRules {
  ...
  private static final Collection<Class<? extends JavaCheck>> checks =
      Arrays.asList(OScommandCheck.class, RequestHeaderCheck.class, MessageDigestCustomCheck.class,
              ...
              XEECheck.class, XPathInjectionCheck.class, SystemExitCheck.class, DeserializationCheck.class,
